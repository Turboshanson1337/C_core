...
START_TEST(strcat_1) {
  char b1[1024] = "";
  char b11[1024] = "";
  char str_1_2[1024] = "BOKA AND ZHOKA!";
...
START_TEST(strcmp_2) {
  char *str_2_1 = "BOKA AND ZHOKA!";
  char *str_2_2 = "LEGENDY BOKA AND ZHOKA!";
...
START_TEST(strcmp_3) {
  char *str_3_1 = "LEGENDY BOKA AND ZHOKA!!!!!";
  char *str_3_2 = "ABOBA!";
...
START_TEST(strncmp_2) {
  s21_size_t n = 3;
  char *str_2_1 = "BOKA AND ZHOKA!";
  char *str_2_2 = "ABO BABOBI AND BIBA!!";
...
START_TEST(strncmp_3) {
  s21_size_t n = 3;
  char *str_3_1 = " ABOBA BI AND BIBA!!";
  char *str_3_2 = "ABOBA!";
...
START_TEST(memcmp_2) {
  s21_size_t n2 = 3;
  void *str_2_1 = "BOKA AND ZHOKA!";
  void *str_2_2 = "LEGENDY BOKA AND SYN ZHOKA!!";
...
START_TEST(memcmp_3) {
  s21_size_t n3 = 3;
  void *str_3_1 = " ABOBA OF AND BIBA!!";
  void *str_3_2 = "ABOBA!";
...
START_TEST(memset_1) {
  s21_size_t n1 = 6;
  int c1 = '7';
  char b1[1024] = "BOKA AND ZHOKA!";
  char b11[1024] = "BOKA AND ZHOKA!";
...
START_TEST(strcpy_2) {
  char b2[1024] = "";
  char b22[1024] = "";
  char str_2_2[1024] = "ABOBA I \0BIBA!!";
...
START_TEST(memcpy_2) {
  ...
  char b2[1024] = "";
  char b22[1024] = "";
  char str_2_2[1024] = "BOKA AND \0ZHOKA!!";
...
START_TEST(memmove_4) {
  s21_size_t n4 = 4;
  char b4[1024] = "777 ABOBA!";
  char b44[1024] = "777 ABOBA!";
  ck_assert_pstr_eq(memmove(b4, b4, n4), s21_memmove(b44, b44, n4));
}
END_TEST

START_TEST(memchr_1) {
  char str[] = "Hello a\0boba\0";
  ck_assert_pstr_eq(memchr(str, 'r', 5), s21_memchr(str, 'r', 5));
}
END_TEST

START_TEST(memchr_2) {
  char str2[] = "pavel.gennadyevichh@microsoft.com";
...
START_TEST(strchr_1) {
  char str[] = "Hello aboba";
  ck_assert_pstr_eq(strchr(str, ' '), s21_strchr(str, ' '));
}
END_TEST

START_TEST(strchr_2) {
  char str2[] = "pavel.gennadyevich\0@microsoft.com";
  ck_assert_pstr_eq(strchr(str2, 'm'), s21_strchr(str2, 'm'));
}
END_TEST

START_TEST(strchr_3) {
  char str3[] = "pavel.gennadyevich@microsoft.com";
...
START_TEST(strrchr_2) {
  char str2[] = "pavel.gennadyevich@microsoft.com";
...
START_TEST(strcspn_1) {
  char str1[] = "allow ti opyat na svyaz vihodish";
  ck_assert_int_eq(strcspn(str1, "ab"), s21_strcspn(str1, "ab"));
}
END_TEST

START_TEST(strcspn_2) {
  char str2[] = "PROSHE POZVONIT: 8-800-555-35-35";
...
START_TEST(strspn_2) {
  char str2[] = "allow ti opyat na svyaz vihodish";
...
START_TEST(strpbrk_2) {
  char str2[] = "pavel.gennadyevich@mic\0rosoft.com";
...
START_TEST(strerror_1) {
  int err_num = 7;
  ck_assert_pstr_eq("Argument list too long", s21_strerror(err_num));
}
END_TEST
...
START_TEST(strerror_2) {
  ...
  char *err[] = ERROR;
  if (*err[0] == 'U') {
    ck_assert_pstr_eq("Unknown error: -10", s21_strerror(err_num2));
  } else {
    ck_assert_pstr_eq("Unknown error -10", s21_strerror(err_num2));
  }
}
...
START_TEST(strerror_3) {
  ...
  char *err[] = ERROR;
  if (*err[0] == 'U') {
    ck_assert_pstr_eq("Unknown error: 133", s21_strerror(err_num3));
  } else {
    ck_assert_pstr_eq("Memory page has hardware error", s21_strerror(err_num3));
  }
}
END_TEST
...
START_TEST(strerror_4) {
  ...
  char *err[] = ERROR;
  if (*err[0] == 'U') {
    ck_assert_pstr_eq("Unknown error: 200", s21_strerror(err_num4));
  } else {
    ck_assert_pstr_eq("Unknown error 200", s21_strerror(err_num4));
  }
}
...
START_TEST(to_upper_1) {
  char str1[] = "hello, aboba!";
  char *str2 = (char *)s21_to_upper(str1);
  ck_assert_pstr_eq(str2, "HELLO, ABOBA!");
  free(str2);
}
END_TEST

START_TEST(to_upper_2) {
  char str1[] = "hello, aboba! 1337";
  char *str2 = (char *)s21_to_upper(str1);
  ck_assert_pstr_eq(str2, "HELLO, ABOBA! 1337");
  free(str2);
}
END_TEST
...
START_TEST(to_lower_2) {
  char str1[] = "HEllO, ABOBA! 1177";
  char *str2 = (char *)s21_to_lower(str1);
  ck_assert_pstr_eq(str2, "hello, aboba! 1177");
  free(str2);
}
END_TEST
...
START_TEST(trim_1) {
  ...
  ck_assert_pstr_eq(psrc, "Hello, AbOBA! *");
  free(psrc);
}
END_TEST
...
START_TEST(strlen_assalamaleykum) {
  char src[] = "assalamaleykum";
  ck_assert_int_eq(s21_strlen(src), strlen(src));
}
END_TEST
...
START_TEST(strlen_assalamaleykum_ez_zhe) {
  char src[] = "assalamaleykum\0ez_zhe";
  ck_assert_int_eq(s21_strlen(src), strlen(src));
}
END_TEST
...
START_TEST(strlen_Pizza_iz_TATmaka) {
  char src[] = "Pizza_iz_TATmaka";
  ck_assert_int_eq(s21_strlen(src), strlen(src));
}
END_TEST

START_TEST(strlen_kbIstbIburger_s_koninoi) {
  char src[] = "KbIstbIburger s koninoi";
  ck_assert_int_eq(s21_strlen(src), strlen(src));
}
END_TEST

START_TEST(strlen_tybetey) {
  char src[] = "tybetey";
  ck_assert_int_eq(s21_strlen(src), strlen(src));
}
END_TEST
...
START_TEST(strncat_string) {
  char src[] = "assalamaleykum";
  char res[25] = "bratishka";
  char expected[25] = "bratishka";
  s21_size_t n_byte = 6;
  s21_strncat(res, src, n_byte);
  strncat(expected, src, n_byte);
  ck_assert_mem_ge(res, expected, n_byte);
...
START_TEST(strncat_ISENMESES) {
  char src[] = "ISENMESES";
  char res[25] = "ISENMESES";
  char expected[25] = "ISENMESES";
  s21_size_t n_byte = 5;
  s21_strncat(res, src, n_byte);
  strncat(expected, src, n_byte);
  ck_assert_mem_ge(res, expected, n_byte);
...
START_TEST(strncmp_tybetey_tybetey) {
  char str1[] = "tybetey";
  char str2[] = "tybetey";
  s21_size_t n_byte = 6;
  int got = s21_strncmp(str1, str2, n_byte);
...
START_TEST(strncmp_tybetey_tybetey_zero_byte) {
  char str1[] = "tybeteybazbazRehmet";
  char str2[] = "tybeteybaz";
  s21_size_t n_byte = 10;
  int got = s21_strncmp(str1, str2, n_byte);
  int expected = strncmp(str1, str2, n_byte);
  if (got > 1) got = 1;
...
START_TEST(strncmp_tybetey_tybetey_one_byte) {
  char str1[] = "tybetey";
  char str2[] = "tybetey";
  s21_size_t n_byte = 1;
  int got = s21_strncmp(str1, str2, n_byte);
...
START_TEST(strstr_Kazani_test) {
  char haystack[] = "Privet iz Kazani!";
  char needle[] = "Kazani";
  ck_assert_pstr_eq(s21_strstr(haystack, needle), strstr(haystack, needle));
}
END_TEST
...
START_TEST(strstr_not_word_in_haystack) {
  char haystack[] = "ANDre is no right word in this test!";
  char needle[] = "NOT";
  ck_assert_pstr_eq(s21_strstr(haystack, needle), strstr(haystack, needle));
}
END_TEST
...
START_TEST(strtok_correct_token_string) {
  char str1[] = "Aboba++tybetey_! Rehmet====!Tatmak";
  char str2[] = "Aboba++tybetey_! Rehmet====!Tatmak";
  const char delims[] = "+_! =";
...
START_TEST(strtok_hard_token_string) {
  char str1[] = "++Aboba++tybetey_! Rehmet===!Tatmak+++ A +";
  char str2[] = "++Aboba++tybetey_! Rehmet===!Tatmak+++ A +";
  const char delims[] = "+_! =";
  char *got = s21_strtok(str1, delims);
  char *expected = strtok(str2, delims);
  ck_assert_uint_eq(s21_strlen(got), s21_strlen(expected));
...
START_TEST(strtok_unary_delimiters) {
  char str1[] = "Aboba+Anuroba_tybetey!Rehmet_Kekus";
  char str2[] = "Aboba+Anuroba_tybetey!Rehmet_Kekus";
  const char delims[] = "+_! =";
  char *got = s21_strtok(str1, delims);
  char *expected = strtok(str2, delims);
  ck_assert_uint_eq(s21_strlen(got), s21_strlen(expected));
...
START_TEST(strtok_too_many_uses_non_segfault) {
  char str1[] = "Aboba_tybetey_Roba";
  char str2[] = "Aboba_tybetey_Roba";
  const char delims[] = "+_! =";
  char *got = s21_strtok(str1, delims);
  char *expected = strtok(str2, delims);
  ck_assert_uint_eq(s21_strlen(got), s21_strlen(expected));
...
START_TEST(strtok_odd_n_of_delims) {
  char str1[] = "Aboba__+tybetey_  Roba";
  char str2[] = "Aboba__+tybetey_  Roba";
  const char delims[] = "+_! =";
  char *got = s21_strtok(str1, delims);
  char *expected = strtok(str2, delims);
  ck_assert_uint_eq(s21_strlen(got), s21_strlen(expected));
...
START_TEST(strtok_mixed_n_of_delims) {
  char str1[] = "Aboba__tybetey_+++Roba_Kepa";
  char str2[] = "Aboba__tybetey_+++Roba_Kepa";
  const char delims[] = "+_! =";
  char *got = s21_strtok(str1, delims);
  char *expected = strtok(str2, delims);
  ck_assert_uint_eq(s21_strlen(got), s21_strlen(expected));
...
START_TEST(strtok_mixed_hard_incorrect) {
  char str1[] = "!Aboba__ !T!atm ak____Abiba+Ke!!!klol";
  char str2[] = "!Aboba__ !T!atm ak____Abiba+Ke!!!klol";
  const char delims[] = "+_! =";
  char *got = s21_strtok(str1, delims);
  char *expected = strtok(str2, delims);
  ck_assert_uint_eq(s21_strlen(got), s21_strlen(expected));
...
START_TEST(strerror_all_std_errors) {
  char *err[] = ERROR;
  for (int i = 1; i < 107; i++) {
    char *expected = s21_strerror(i);
    ck_assert_str_eq(err[i], expected);
  }
}
END_TEST
...
START_TEST(strerror_negative_err_code) {
  ...
  for (int i = -1000; i < 0; i++) {
    const char *got = s21_strerror(i);
    char *test = (char *)calloc(30, 1);
    if (test) {
      if (*err[0] == 'U') {
        s21_sprintf(test, "Unknown error: %d", i);
      } else {
        s21_sprintf(test, "Unknown error %d", i);
      }
    }
    ck_assert_str_eq(test, got);
    if (test) {
      free(test);
    }
  }
...
// // strchr ->
START_TEST(strchr_abobatatmak_find_a) {
  char src[] = "abobatatmak";
  char find = 'a';
...
START_TEST(strchr_abobakbIstbIbbIi_find_1) {
  char src[] = "abobakbIstbIbbIi";
  char find = '1';
  ck_assert_pstr_eq(s21_strchr(src, find), strchr(src, find));
}
END_TEST

START_TEST(strchr_abobatatmAk_find_Z) {
  char src[] = "abobatatmAk";
  char find = 'Z';
  ck_assert_pstr_eq(s21_strchr(src, find), strchr(src, find));
}
...
START_TEST(strchr_abobatatmAk_find_3) {
  char src[] = "abobatatmAk";
  char find = '3';
  ck_assert_pstr_eq(s21_strchr(src, find), strchr(src, find));
}
...
// // strcpy ->
START_TEST(strcpy_aboba_tybetey) {
  char src[] = " tybetey!!!";
  char res[5 + 15] = "aboba ";
...
START_TEST(strcpy_hard_test) {
  char src[] = "ad[sofijpoiajsdf pj98981h23 p9h tybetey!!!";
...
START_TEST(to_lower_test1) {
  char str[] = "PIZZA IZ TATMAKA?";
  char expected[] = "pizza iz tatmaka?";
...
START_TEST(sprintf_simple_ifinit) {
  char str1[BUFF_SIZE] = {0};
  char str2[BUFF_SIZE] = {0};

  char *format = "This is a simple infinite value %f";
  double val = INFINITY;
  ck_assert_int_eq(s21_sprintf(str1, format, val), sprintf(str2, format, val));
...
START_TEST(sprintf_simple_nan) {
  char str1[BUFF_SIZE] = {0};
  char str2[BUFF_SIZE] = {0};

  char *format = "This is a simple nan value %f";
  double val = NAN;
  ck_assert_int_eq(s21_sprintf(str1, format, val), sprintf(str2, format, val));
...
START_TEST(sprintf_flags_anoANDr_long_int) {
  char str1[BUFF_SIZE] = {0};
  char str2[BUFF_SIZE] = {0};
...
START_TEST(sprintf_ll_int) {
  char str1[BUFF_SIZE] = {0};
  char str2[BUFF_SIZE] = {0};

  char *format = "%lld";
  long long int val = 9223372036854775806;
  ck_assert_int_eq(s21_sprintf(str1, format, val), sprintf(str2, format, val));
  ck_assert_str_eq(str1, str2);
}
END_TEST

START_TEST(sprintf_hh_int) {
  char str1[BUFF_SIZE] = {0};
  char str2[BUFF_SIZE] = {0};
...
START_TEST(sprintf_octal_ll) {
  char str1[BUFF_SIZE] = {0};
  char str2[BUFF_SIZE] = {0};

  char *format = "%llo";
  unsigned long long int val = 4294967295;
  ck_assert_int_eq(s21_sprintf(str1, format, val), sprintf(str2, format, val));
...
START_TEST(sprintf_hex_ll) {
  char str1[BUFF_SIZE] = {0};
  char str2[BUFF_SIZE] = {0};

  char *format = "%30llx";
  unsigned long int val = 4294967295;
  ck_assert_int_eq(s21_sprintf(str1, format, val), sprintf(str2, format, val));
...
START_TEST(sprintf_string_s21_NULL) {
  char str1[BUFF_SIZE] = {0};
  char str2[BUFF_SIZE] = {0};
...
START_TEST(sprintf_n_specifier) {
  ...
  char str2[BUFF_SIZE] = {0};
  int ret = 0;
  char *format = "Assalam aleykub, budesh pizzu iz Tatmaka? m? %n";
...
START_TEST(sprintf_empty_format_and_parameters) {
  ...
  ck_assert_int_eq(s21_sprintf(str1, "abv"), sprintf(str2, "abv"));
...
START_TEST(sprintf_test_short_hex) {
  char str1[BUFF_SIZE] = {0};
  char str2[BUFF_SIZE] = {0};
  ck_assert_int_eq(s21_sprintf(str1, "%hx", (unsigned)INT32_MIN),
                   sprintf(str2, "%hx", (unsigned short)INT32_MIN));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(s21_sprintf(str1, "%x", 0), sprintf(str2, "%x", 0));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(s21_sprintf(str1, "%hhx", INT32_MAX),
                   sprintf(str2, "%hhx", (unsigned char)INT32_MAX));
  ck_assert_str_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_test_many_hex_lower_with_precision_and_oANDr) {
  char str1[BUFF_SIZE] = {0};
  char str2[BUFF_SIZE] = {0};
  int a = s21_sprintf(
...
START_TEST(sprintf_test_many_hex_upper_with_precision_and_oANDr) {
  char str1[BUFF_SIZE] = {0};
  char str2[BUFF_SIZE] = {0};
...
START_TEST(sprintf_test_sprintf7) {
  ...
  ck_assert_int_eq(s21_sprintf(str1, format, "aboba tybetey"),
                   sprintf(str2, format, "aboba tybetey"));
...
START_TEST(sprintf_test_sprintf17) {
  ...
  ck_assert_int_eq(s21_sprintf(str1, format, "aboba likes tybetey"),
                   sprintf(str2, format, "aboba likes tybetey"));
...
START_TEST(sprintf_test_sprintf24) {
  ...
  ck_assert_int_eq(
      s21_sprintf(str1, format, 'f', 21, 42, 666.666,
                  "Celiy denb bbI el pizzu iz Tatmaka. No joke.", 11),
...
Suite *suite_insert(void) {
  ...
  tcase_add_test(tc, strlen_assalamaleykum);
  tcase_add_test(tc, strlen_num);
  tcase_add_test(tc, strlen_string);
  tcase_add_test(tc, strlen_assalamaleykum_ez_zhe);
  tcase_add_test(tc, strlen_dai_mne_pen);
  tcase_add_test(tc, strlen_Floppy_disk);
  tcase_add_test(tc, strlen_tybetey);
  tcase_add_test(tc, strlen_kbIstbIburger_s_koninoi);
  tcase_add_test(tc, strlen_Pizza_iz_TATmaka);

  tcase_add_test(tc, strncat_all_empty);
  tcase_add_test(tc, strncat_zero_byte);
  tcase_add_test(tc, strncat_empty_src);
  tcase_add_test(tc, strncat_cd_assalam);
  tcase_add_test(tc, strncat_string);
  tcase_add_test(tc, strncat_ISENMESES);
  tcase_add_test(tc, strncat_ISENMESES2);
  tcase_add_test(tc, strncat_ISENMESES3);
  tcase_add_test(tc, strncat_ISENMESES4);
  tcase_add_test(tc, strncat_zero_char);

  tcase_add_test(tc, strncmp_empty);
  tcase_add_test(tc, strncmp_tybetey_);
  tcase_add_test(tc, strncmp__tybetey);
  tcase_add_test(tc, strncmp_tybetey_tybetey);
  tcase_add_test(tc, strncmp_tybetey_tybetey_zero_byte);
  tcase_add_test(tc, strncmp_tybetey_tybetey_one_byte);
  ...
  tcase_add_test(tc, strstr_Kazani_test);
  ...
  tcase_add_test(tc, strchr_abobatatmak_find_a);
  tcase_add_test(tc, strchr_abobatatmAk_find_A);
  tcase_add_test(tc, strchr_abobakbIstbIbbIi_find_1);
  tcase_add_test(tc, strchr_abobatatmAk_find_Z);
  tcase_add_test(tc, strchr_abobatatmAk_find_3);
  tcase_add_test(tc, strchr_empty_src);

  tcase_add_test(tc, strcpy_aboba_tybetey);
  tcase_add_test(tc, strcpy__tybetey);
  ...
  tcase_add_test(tc, sprintf_simple_ifinit);
  tcase_add_test(tc, sprintf_simple_nan);
  ...
  tcase_add_test(tc, sprintf_flags_anoANDr_long_int);
  ...
  tcase_add_test(tc, sprintf_octal_ll);
  tcase_add_test(tc, sprintf_octal_hh);
  ...
  tcase_add_test(tc, sprintf_hex_ll);
  ...
  tcase_add_test(tc, sprintf_string_s21_NULL);
  ...
  tcase_add_test(tc, sprintf_ll_int);
  tcase_add_test(tc, sprintf_hh_int);
  ...
  tcase_add_test(tc, sprintf_test_short_hex);
  ...
  tcase_add_test(tc, sprintf_test_many_hex_lower_with_precision_and_oANDr);
  tcase_add_test(tc, sprintf_test_many_hex_upper_with_precision_and_oANDr);
